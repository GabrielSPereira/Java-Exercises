...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void operacao(float valor)
    {
        ...
        {
            case 1:
                this.valorparcial = this.valorparcial + valor;
                break;
            case 2:
                this.valorparcial = this.valorparcial - valor;
                break;
            ...
            case 4:
                ...
                break;
            case 5: // porcentagem
                this.valorparcial = this.valorparcial / 100 * valor;
                break;
        }   
        try{
            if (Float.toString(this.valorparcial).length() >= 8){
                  throw new MaisOitoCaracteres();
            }else{
                jTextField1.setText(Float.toString(this.valorparcial));
            }
        }catch(MaisOitoCaracteres  e){
            System.out.println(e + "Resultado com mais de 8 caracteres");
            jTextField1.setText("");
        }
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jButton19, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if(verificaCampo(jTextField1.getText().length())){
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        if(jTextField1.getText().length() != 0){
            this.valorparcial = Float.parseFloat(jTextField1.getText());
            this.tipooperacao = 3;
            jTextField1.setText("");
        }
    ...
    private Boolean verificaCampo(int quantidade) {
        return quantidade <= 8;
    }

    private static class MaisOitoCaracteres extends Exception {

        public MaisOitoCaracteres() {
        }
    }
}
